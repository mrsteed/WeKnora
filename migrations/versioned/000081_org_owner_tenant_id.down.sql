-- Reverse migration for 000081_org_owner_tenant_id.
--
...
DO $$ BEGIN RAISE NOTICE '[Migration 000081] Dropping organizations.owner_tenant_id'; END $$;
...
DO $$ BEGIN RAISE NOTICE '[Migration 000081] organizations.owner_tenant_id removed'; END $$;
