        ...
        case 'complete':
            ...
            if (message.agentEventStream) {
                ...
                if (existingCompleteEvent) {
                    existingCompleteEvent.total_duration_ms = data.data?.total_duration_ms || existingCompleteEvent.total_duration_ms || 0;
                    existingCompleteEvent.total_steps = data.data?.total_steps || existingCompleteEvent.total_steps || 0;
                } else {
                    message.agentEventStream.push({
                        type: 'agent_complete',
