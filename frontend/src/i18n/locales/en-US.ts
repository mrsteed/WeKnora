export default {
  ...
  agent: {
    ...
    pageShare: {
      manageTitle: 'Agent Sharing',
      manageDesc: 'Configure how the agent is shared. You can share it via a public link for read-only visitors, or share it to a space for collaborative use.',
      sectionTitle: 'Link Sharing',
      sectionDesc: 'Enable to generate a dedicated access link that lets visitors use this agent in read-only mode.',
      emptyTitle: 'Link sharing not enabled',
      emptyDesc: 'Enable link sharing to generate a dedicated access link and invite others to use this agent in read-only mode.',
      enable: 'Enable Link Sharing',
      disable: 'Disable Link Sharing',
      enableSuccess: 'Link sharing enabled',
      disableSuccess: 'Link sharing disabled',
      ...
      disabledHint: 'Link sharing is disabled. Visitors will not be able to access this agent via the link.',
      statusActive: 'Active',
      statusDisabled: 'Disabled',
      statusExpired: 'Expired',
      notReady: 'The agent is not fully configured for link sharing yet. Please try again later.',
    ...
    editor: {
      ...
      basicInfoDesc: 'Configure agent name, description, visibility, and run mode',
  ...
  knowledgeEditor: {
    ...
    database: {
      ...
      description: 'Configure connection settings for a database knowledge base and constrain the tables and columns it can access.',
      engineLabel: 'Database Engine',
      engineTip: 'Choose the database type to connect. MySQL and PostgreSQL are currently supported.',
      dataSourceNameLabel: 'Data Source Name',
      dataSourceNamePlaceholder: 'Enter a data source name (optional)',
      dataSourceNameTip: 'Used only as an internal label for this knowledge base. Defaults to the knowledge base name when left empty.',
      hostLabel: 'Host',
      hostPlaceholder: 'For example: 192.168.1.10',
      portLabel: 'Port',
      portPlaceholder: 'Enter port number',
      databaseNameLabel: 'Database Name',
      databaseNamePlaceholder: 'Enter database name',
      schemaLabel: 'Schema',
      schemaPlaceholder: 'Enter schema name',
      usernameLabel: 'Username',
      usernamePlaceholder: 'Enter database username',
      passwordLabel: 'Password',
      passwordPlaceholder: 'Enter database password',
      sslModeLabel: 'SSL Mode',
      sslModePlaceholder: 'For example: false, require, disable',
      sslModeTip: 'Common MySQL values are false / true / skip-verify; common PostgreSQL values are disable / require / verify-ca.',
      queryConstraintTitle: 'Query Constraints',
      queryConstraintDescription: 'Limit the tables and columns this knowledge base can access. Enter one table or field per line; leave blank for no extra restriction.',
      tableAllowlistLabel: 'Allowed Tables',
      tableAllowlistPlaceholder: 'One table per line, for example: orders',
      tableAllowlistTip: 'Only these tables can be accessed. Leave empty to allow every table in the current database.',
      columnDenylistLabel: 'Blocked Columns',
      columnDenylistPlaceholder: 'One field per line, for example: users.password',
      columnDenylistTip: 'These columns are filtered out from schema discovery and query generation. Add sensitive fields such as passwords, secrets, or national IDs.',
      maxRowsLabel: 'Max Rows Per Query',
      maxRowsPlaceholder: 'For example: 200',
      timeoutLabel: 'Query Timeout (seconds)',
      timeoutPlaceholder: 'For example: 15',
      testConnection: 'Test Connection',
      ...
      testRequired: 'Test the database connection before creating the knowledge base',
    },
    wiki: {
      title: 'Wiki Settings',
...
\
  ...
  chat: {
    ...
    webFetchStatusTitle: 'Fetch status',
    webFetchRequestedLabel: 'Requested pages',
    webFetchFetchedLabel: 'Fetched pages',
    webFetchFailedLabel: 'Failed pages',
    webFetchAllFailedNotice: 'No full-page content was fetched. Any downstream answer should rely on prior web search snippets.',
    webFetchPartialNotice: 'Fetched full-page content for {fetched} of {requested} pages. Remaining pages should be treated as snippet-only evidence.',
  ...
  agentEditor: {
    ...
    tools: {
      ...
      requiresDatabaseKb: '(requires a database knowledge base)',
    ...
    agentType: {
      ...
      kbMismatch: {
        ...
        databaseAnalysis: 'Requires a database knowledge base',
