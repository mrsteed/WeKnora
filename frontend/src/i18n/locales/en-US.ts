export default {
  ...
  knowledgeBase: {
    ...
    folderTree: {
      ...
      deleteConfirm: 'Delete the empty folder "{name}"?',
      deleteBlocked: 'Folder {name} still contains {count} document(s). Move or delete them before removing the folder.',
    ...
    locateInKb: 'Locate in knowledge base',
    ...
    batchDownloadDownloading: 'Preparing download…',
  ...
  agent: {
    ...
    editor: {
      ...
      visibilityTip: 'Organization: visible to the current account\'s organization and its child organizations. Global: visible to all organizations in the current workspace.',
      organizationLabel: 'Organization',
      orgRequired: 'The current account is not assigned to any organization, so organization visibility cannot be used.',
      description: 'Description',
  ...
  settings: {
    ...
    sandbox: {
      ...
      backendDescriptions: {
        ...
        docker: 'Run every script in a short-lived container on this IntraMind host',
        local: 'Run scripts directly in the IntraMind server process environment',
      },
      ...
      weknoraTemplateTitle: 'IntraMind standard template',
      weknoraDockerImage: 'IntraMind standard image',
      ...
      localRuntimeWarning: 'Local process runs skill scripts directly on the IntraMind server without container or MicroVM isolation. Use only in a trusted development workspace.',
      weknoraTemplateOverview: 'IntraMind provides the standard runtime. Templates are discovered after connecting and the standard one is created when missing.',
      weknoraTemplateDescription: 'Includes the Python, Node.js, CLI tools, workspace path, and non-root execution user expected by IntraMind skills.',
      ...
      localRuntimeSummary: 'IntraMind server process',
      ...
      templateLoadHint: 'Enter the cluster connection and refresh. IntraMind creates its standard template when missing.',
      templateLoadFailed: 'Failed to load templates',
      standardTemplateProvisioning: 'The IntraMind standard template is being created. Refresh shortly to see its status.',
      ...
      templateStepHint: 'IntraMind automatically creates its standard template when missing. You can continue after a template is ready.',
      ...
      templateUntaggedHint: 'The builds finished but none carries the default tag, so sandbox creation cannot resolve this template. Delete it in E2B and refresh; IntraMind will rebuild it.',
  ...
  auth: {
    ...
    firstTime: 'New to IntraMind?',
    registerSuccess: 'Registration successful. Please sign in',
    registerFailed: 'Registration failed',
    subtitle: 'Sign in to continue',
    registerSubtitle: 'Create your account and start using IntraMind',
  ...
  admin: {
    ...
    member: {
      ...
      roleEditor: 'Editor',
      roleAdmin: 'Admin',
      roleSubOrgAdmin: 'Sub-org Admin',
      adjustInTenantMembers: 'Adjust this workspace-level role in Tenant Members',
      ...
      departmentMoved: 'Member moved to the new department',
    ...
    org: {
      createNode: 'Create Organization Node',
      editNode: 'Edit Organization Node',
      nameLabel: 'Organization Name',
      namePlaceholder: 'Please enter the organization name',
      descriptionLabel: 'Description',
      descriptionPlaceholder: 'Please enter a description (optional)',
      parentOrgLabel: 'Parent Organization',
      parentOrgPlaceholder: 'Select a parent (clear to make it a root)',
      parentInvalid: 'Cannot set a node as its own descendant',
      sortOrder: 'Sort Order',
      nameRequired: 'Please enter the organization name',
      createRoot: 'Create Root Organization',
      createFirst: 'Create First Organization',
      emptyTree: 'No organization data yet',
  ...
  createChat: {
    title: 'Hi, I am IntraMind — your knowledge, within reach',
  ...
  embedPublish: {
    ...
    webhookUrlDesc: 'Optional. IntraMind POSTs message_sent / message_received events to this HTTPS endpoint.',
  ...
  chat: {
    ...
    referenceDownloadDenied: 'Your account does not have permission to download this document. Please contact the knowledge base admin.',
  ...
  tenant: {
    ...
    setupWizard: {
      ...
      subtitle: 'Finish the first owner onboarding and org-tree bootstrap for {name}.',
      tip: 'Create the tenant membership first, then assign org-tree scope, so the new user can log in immediately.',
      skip: 'Skip and enter workspace',
      enter: 'Enter workspace',
      finish: 'Run setup',
      introDesc: 'Choose an existing account, create a new user, or generate an invite link, then assign the tenant-level role.',
      modeLabel: 'Responsible person onboarding mode',
      tenantRoleLabel: 'Workspace role',
      tenantRoleDesc: 'This role controls what the user can manage after entering the workspace.',
      existingEmailLabel: 'Existing account email',
      existingEmailPlaceholder: "For example: name{'@'}example.com",
      existingEmailHint: 'The user must already be registered in the system. If not, use “Create user” or “Invite link” instead.',
      inviteMessageLabel: 'Invite note (optional)',
      inviteMessagePlaceholder: 'For example: register first, then contact the admin for org assignment',
      rootOrgTitle: 'Org-tree bootstrap',
      rootOrgDesc: 'Create the first root org for this workspace and, when possible, attach the responsible person to it.',
      createRootToggle: 'Create the root organization now',
      rootOrgRequiredHint: 'Create-user mode depends on an org node; the wizard creates the root org before provisioning the account.',
      rootOrgNameLabel: 'Root organization name',
      rootOrgNamePlaceholder: 'For example: {name}',
      rootOrgDescLabel: 'Root organization description (optional)',
      rootOrgDescPlaceholder: 'For example: default root department / HQ',
      orgRoleLabel: 'Organization role',
      orgRoleDesc: 'Org roles scope people and resources inside the org tree; they are not the same as workspace admin roles.',
      inviteOrgHint: 'Invite-link mode does not auto-assign an org role. After the user registers and joins, place them into the org tree manually.',
      retryReuseRootHint: 'The root organization already exists; retries will reuse “{name}”.',
      resultTitle: 'Setup complete',
      resultDesc: 'The workspace has been switched to {name}. You can enter it now and continue configuring it.',
      resultOrgCreated: 'Created root organization “{name}”.',
      resultOrgSkipped: 'No org-tree node was created in this run.',
      resultExisting: 'Added {email} to the current workspace.',
      resultExistingWithOrg: 'Added {email} to the current workspace and attached them to “{org}”.',
      resultNewUserWithOrg: 'Created account “{username}” and assigned it to “{org}”.',
      resultInvite: 'Generated a reusable invite link. The recipient can join this workspace after completing registration.',
      ...
      modes: {
        existing: {
          ...
          desc: 'Add an already-registered user to this workspace by email',
        },
        new: {
          title: 'Create user',
          desc: 'Create the account, grant workspace access, and attach it to an org node',
        },
        invite: {
          title: 'Invite link',
          desc: 'Generate a registration link so the recipient can join later',
        },
      },
      errors: {
        rootOrgNameRequired: 'Please enter a root organization name',
        existingEmailRequired: 'Please enter the existing account email',
        existingUserNotFound: 'No registered account was found for this email. Use “Create user” or “Invite link” instead.',
        generic: 'Workspace setup failed. Please try again later.',
        missingInviteLink: 'The invite link was created, but no copyable URL was returned.',
      },
      warnings: {
        newUserPartial: 'The account was created and added to the workspace, but org assignment did not fully succeed: {message}',
      },
    },
    messages: {
  ...
  platform: {
    subtitle: 'Scattered docs, a living knowledge brain',
    description: 'Answers, reasons, grows — your enterprise inner mind',
    ...
    tagAnswer: 'Answers · with citations',
    tagReason: 'Reasoning · step-by-step',
    tagGrow: 'Self-growing · auto Wiki',
    tagPrivate: 'Fully private',
    loginFeatAnswer: 'Multimodal parsing: PDF / scans / tables / video',
    loginFeatReason: 'Hybrid search: vector + BM25 + knowledge graph',
    loginFeatGrow: 'Auto Wiki: knowledge that grows itself',
    trustLine: 'Private deployment · 20+ model vendors · audit trail',
  ...
  integrations: {
    ...
    api: {
      ...
      hmacSecretDesc: 'Same secret stored in IntraMind; used only on your backend to sign JWTs—never send it as a request header.',
    ...
    chrome: {
      ...
      subtitle: 'For self-hosted IntraMind: ask questions in a sidebar, clip web pages, and save Markdown notes into your knowledge bases while you browse.',
      ...
      steps: {
        ...
        port: {
          ...
          desc: 'On IntraMind Desktop, set a fixed API port (e.g. 37841) in API Info so the URL stays stable across restarts.'
        },
        install: {
    ...
    claw: {
      title: 'IntraMind Skill',
      subtitle: 'Import documents and run hybrid retrieval (vector + keyword) via the IntraMind REST API—for uploads, URL imports, Markdown entries, and cross-KB search.',
      ...
      installCtaHint: 'Install IntraMind Skill · opens in a new tab',
