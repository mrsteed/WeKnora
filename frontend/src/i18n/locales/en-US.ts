export default {
  ...
  knowledgeBase: {
    ...
    databaseDetail: {
      breadcrumb: 'Database Details',
      subtitle: 'Manage connections, schema snapshots, and query audits for database knowledge bases',
      hero: {
        kicker: 'Business Database Knowledge Base',
        title: 'Connect the business DB and maintain queryable schema coverage',
        description: 'This knowledge base serves live business database access, focusing on queryable table structure, field boundaries, and query traces instead of document upload.',
        connection: 'Current Access',
        connectionEmpty: 'Not configured',
        connectionHint: 'Create a database connection to pull business table structures',
        facts: {
          source: 'Data source',
          database: 'Business DB',
          schema: 'Schema',
          tables: 'Queryable tables',
          tablesSuffix: '',
          refreshedAt: 'Latest schema refresh',
        },
      },
      cards: {
        datasource: {
          tag: 'Link',
          eyebrow: 'Business DB Access',
          empty: 'No data source configured',
          suffix: 'database',
          meta: 'Configure the connection to read business database structures',
          connector: 'Connector',
          address: 'Address',
          refreshTime: 'Refreshed at',
        },
        schema: {
          tag: 'Schema',
          eyebrow: 'Queryable Schema',
          empty: 'Waiting for first refresh',
          suffix: 'business tables',
          database: 'Business DB',
          fields: 'Field count',
          viewsLabel: 'Views',
          views: 'views',
        ...
        guard: {
          tag: 'Guard',
          eyebrow: 'Query Safeguards',
          title: 'Read-only Query Boundary',
          suffix: 'row limit',
          scope: 'Scoped to',
          scopeSuffix: 'tables',
          timeoutLabel: 'Timeout',
          scopeLabel: 'Allowed tables',
        ...
        audit: {
          ...
          suffix: 'records',
          latest: 'Latest',
          latestLabel: 'Latest query',
          statusLabel: 'Audit status',
          statusReady: 'Tracked',
          statusEmpty: 'No records',
          scopeLabel: 'Related tables',
        },
      },
      scenarios: {
        title: 'Design Focus',
        item1: 'This page targets live structured queries, so document upload, tags, and file lists are removed.',
        item2: 'Connections and schema snapshots become the center, making current databases, tables, views, and query boundaries easier to inspect.',
        item3: 'The default path assumes read-only accounts and highlights refresh schema, inspect structure, and review query audit as the core actions.',
      },
      workflow: {
        title: 'Recommended Flow',
        item1: 'Maintain the database connection and verify account, host, database name, and query constraints.',
        item2: 'Refresh the schema snapshot so agents and users can see the latest tables and field constraints.',
        item3: 'Review query audits to trace executed SQL, outcomes, and operational risk.',
      },
      snapshot: {
  ...
  agent: {
    ...
    pageShare: {
      ...
      manageDesc: 'Share this agent as a restricted public chat page, or continue sharing it to spaces for members.',
      sectionTitle: 'Page Share',
      sectionDesc: 'Generate a login-free chat link. Visitors can only ask questions with the current agent configuration and cannot change any settings.',
      emptyTitle: 'Page share is not enabled yet',
      emptyDesc: 'After enabling, a stable share link will be created and can be sent directly to external visitors.',
      enable: 'Enable Share',
      ...
      enableSuccess: 'Page share enabled',
      disableSuccess: 'Page share disabled',
  ...
  auth: {
    ...
    currentPasswordPlaceholder: 'Enter your current password for verification',
    ...
    accountRequired: 'Enter username, email, or phone number',
  ...
  knowledgeEditor: {
    ...
    basic: {
      ...
      typeDescription: 'FAQ suits structured Q&A datasets; document type supports file parsing and chunking; database type binds an external database for realtime read-only querying; Wiki type auto-builds interlinked knowledge pages via LLM.',
      ...
      visibilityOrg: 'Organization Visible',
    ...
    database: {
      ...
      description: 'Configure the external database connection. Creation validates the connection and initializes the first schema snapshot automatically.',
      engineLabel: 'Database Engine',
      engineTip: 'MySQL and PostgreSQL are supported for now. The datasource will be bound to this database knowledge base after creation.',
      dataSourceNameLabel: 'Datasource Name',
      dataSourceNamePlaceholder: 'Defaults to the knowledge base name when left empty',
      dataSourceNameTip: 'Optional label shown later on the Data Sources page.',
      hostLabel: 'Host',
      hostPlaceholder: '127.0.0.1',
      portLabel: 'Port',
      portPlaceholder: '3306',
      databaseNameLabel: 'Database',
      databaseNamePlaceholder: 'crm',
      schemaLabel: 'Schema',
      schemaPlaceholder: 'public',
      usernameLabel: 'Username',
      usernamePlaceholder: 'readonly_user',
      passwordLabel: 'Password',
      passwordPlaceholder: 'Enter the readonly password',
      sslModeLabel: 'SSL Mode',
      sslModePlaceholder: 'MySQL: false / preferred / required; PostgreSQL: disable / require / verify-full',
      sslModeTip: 'Leave empty to use the default mode for the selected database engine.',
      queryConstraintTitle: 'Query Constraints',
      queryConstraintDescription: 'Restrict accessible tables and columns, and configure default row and timeout limits for the agent.',
      tableAllowlistLabel: 'Table Allowlist',
      tableAllowlistPlaceholder: 'orders\ncustomers\norder_items',
      tableAllowlistTip: 'Leave empty to allow all visible tables. Use commas or line breaks to separate table names.',
      columnDenylistLabel: 'Column Denylist',
      columnDenylistPlaceholder: 'password_hash\nid_card\nmobile',
      columnDenylistTip: 'These columns are treated as sensitive and blocked from schema display and live queries.',
      maxRowsLabel: 'Max Rows',
      maxRowsPlaceholder: '200',
      timeoutLabel: 'Query Timeout (sec)',
      timeoutPlaceholder: '15',
      testConnection: 'Test Connection',
      testSuccess: 'Connection succeeded',
      testFailed: 'Connection failed',
      testRequired: 'Please test the database connection first',
...
\
  ...
  chat: {
    ...
    queryDurationLabel: 'Query duration:',
    queryDisplayedRowsLabel: 'Showing {displayed} of {total} rows',
    queryOmittedRowsLabel: '{count} more row(s) hidden',
    queryDatabaseTruncatedLabel: 'Database result truncated by max_rows',
    queryOutputTruncatedLabel: 'Model output budget applied',
    queryCellTruncatedCountLabel: '{count} cell(s) truncated',
    schemaOutputModeLabel: 'Schema output mode:',
    schemaUpdatedAtLabel: 'Schema refreshed at:',
    schemaHashLabel: 'Schema hash:',
    schemaTableCountLabel: 'Table count:',
    schemaColumnCountLabel: 'Column count:',
    schemaAllowedTablesLabel: 'Allowed tables',
    schemaForeignKeysLabel: 'Foreign keys',
    schemaPossibleJoinHintsLabel: 'Possible join hints',
    schemaJoinHintsLabel: 'Join hints',
    schemaSampleQueriesLabel: 'Sample queries',
    schemaPrimaryKeysLabel: 'Primary keys:',
    schemaColumnsLabel: 'Columns',
    schemaIndexesLabel: 'Indexes:',
    schemaRowEstimateLabel: 'Row estimate:',
    schemaAdditionalTablesOmitted: '{count} more table(s) omitted',
    schemaAdditionalColumnsOmitted: '{count} more column(s) omitted',
    schemaEmptyLabel: 'No schema table data available',
  ...
  agentEditor: {
    ...
    tools: {
      ...
      statusKb: 'In scope: {rag} RAG KBs · {wiki} Wiki KBs · {database} Database KBs',
      kbMetricRag: 'RAG KBs',
      kbMetricWiki: 'Wiki KBs',
      kbMetricDatabase: 'Database KBs',
  ...
  datasource: {
    ...
    lastSync: 'Last sync',
    lastStatus: 'Result',
    databaseName: 'Business DB',
    databaseSchemaLabel: 'Schema Scope',
    databaseSchemaDefault: 'Default schema',
    databaseLastSync: 'Last schema refresh',
    databaseLastStatus: 'Schema Status',
    databaseLastStatusReady: 'Schema updated',
    databaseLastStatusPending: 'Schema not collected',
    schedule: 'Schedule',
  ...
  admin: {
    ...
    orgTreeManage: 'Organization Management',
    ...
    org: {
      ...
      descriptionLabel: 'Description',
      descriptionPlaceholder: 'Enter organization description (optional)',
      ...
      deleteSuccess: 'Deleted successfully',
      deleteFailed: 'Delete failed',
      deleteConfirm: 'Are you sure you want to delete this organization node? Child nodes will also be deleted.',
      moveSuccess: 'Moved successfully',
      moveFailed: 'Move failed',
    },
    member: {
      selectOrg: 'Select Organization',
      selectOrgHint: 'Please select an organization on the left',
      ...
      setSuperAdmin: 'Set as Super Admin',
      revokeSuperAdmin: 'Revoke Super Admin',
      superAdmin: 'Super Admin',
      remove: 'Remove',
      removeConfirm: 'Are you sure you want to remove this user from the organization?',
      cannotModifySelf: 'Cannot modify your own permissions',
      assignSuccess: 'Member added successfully',
      ...
      passwordPlaceholder: 'Enter password (8-32 characters)',
      usernamePlaceholder: 'Enter username',
      ...
      resetPasswordFor: 'Reset password for user in "{org}"',
      resetPasswordSuccess: 'Password reset successfully',
      resetPasswordFailed: 'Failed to reset password',
      cannotResetOwnPassword: 'Cannot reset your own password here',
      updateUserSuccess: 'User updated successfully',
      updateUserFailed: 'Failed to update user',
    },
  },
  org: {
    switchPlaceholder: 'Select Organization',
    selectTargetOrg: 'Select Target Organization',
  },
  // Aliases for design-doc convention (kb.visibility* → knowledgeEditor.basic.visibility*)
  kb: {
    visibilityLabel: 'Visibility',
    visibilityPrivate: 'Private',
    visibilityOrg: 'Organization Visible',
