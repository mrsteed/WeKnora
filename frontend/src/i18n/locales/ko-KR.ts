export default {
  ...
  chat: {
    ...
    queryDurationLabel: "조회 시간:",
    queryDisplayedRowsLabel: "{total}개 중 {displayed}개 행 표시",
    queryOmittedRowsLabel: "추가 {count}개 행이 숨겨졌습니다",
    queryDatabaseTruncatedLabel: "데이터베이스 결과가 max_rows로 잘렸습니다",
    queryOutputTruncatedLabel: "모델 출력 예산이 적용되었습니다",
    queryCellTruncatedCountLabel: "{count}개 셀이 잘렸습니다",
    schemaOutputModeLabel: "Schema 출력 모드:",
    schemaUpdatedAtLabel: "Schema 갱신 시각:",
    schemaHashLabel: "Schema 해시:",
    schemaTableCountLabel: "테이블 수:",
    schemaColumnCountLabel: "컬럼 수:",
    schemaAllowedTablesLabel: "허용된 테이블",
    schemaForeignKeysLabel: "실제 외래 키",
    schemaPossibleJoinHintsLabel: "가능한 Join 힌트",
    schemaJoinHintsLabel: "Join 힌트",
    schemaSampleQueriesLabel: "예시 쿼리",
    schemaPrimaryKeysLabel: "기본 키:",
    schemaColumnsLabel: "컬럼",
    schemaIndexesLabel: "인덱스:",
    schemaRowEstimateLabel: "예상 행 수:",
    schemaAdditionalTablesOmitted: "추가 {count}개 테이블이 생략되었습니다",
    schemaAdditionalColumnsOmitted: "추가 {count}개 컬럼이 생략되었습니다",
    schemaEmptyLabel: "표시할 schema 테이블 정보가 없습니다",
  ...
  auth: {
    ...
    rememberUsername: "사용자 이름 기억하기",
    rememberPassword: "비밀번호 기억하기",
    rememberCredentials: "사용자 이름과 비밀번호 기억하기",
