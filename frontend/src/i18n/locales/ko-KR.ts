export default {
  ...
  chat: {
    ...
    webFetchStatusTitle: "가져오기 상태",
    webFetchRequestedLabel: "요청한 페이지 수",
    webFetchFetchedLabel: "성공적으로 가져온 페이지 수",
    webFetchFailedLabel: "가져오기 실패 페이지 수",
    webFetchAllFailedNotice: "어떤 전체 페이지 콘텐츠도 가져오지 못했습니다. 이후 응답은 이전 웹 검색 요약에만 의존해야 합니다.",
    webFetchPartialNotice: "{requested}개 페이지 중 {fetched}개의 전체 페이지 콘텐츠만 가져왔습니다. 나머지 페이지는 검색 요약 근거로만 취급해야 합니다.",
    lengthChars: "{value}자",
  ...
  agent: {
    ...
    editor: {
      ...
      editTitle: "에이전트 편집",
      basicInfo: "기본정보",
      basicInfoDesc: "에이전트 이름, 설명, 공개 범위 및 실행 모드를 구성합니다",
      promptsConfig: "프롬프트",
  ...
  agentEditor: {
    ...
    tools: {
      ...
      requiresDatabaseKb: '(데이터베이스 지식 베이스가 필요합니다)',
    ...
    agentType: {
      ...
      kbMismatch: {
        ...
        databaseAnalysis: '데이터베이스 지식 베이스 필요',
