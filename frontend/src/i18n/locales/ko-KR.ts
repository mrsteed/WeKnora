export default {
  ...
  integrations: {
    ...
    claw: {
      ...
      subtitle: 'IntraMind REST API로 문서를 가져오고 하이브리드 검색(벡터+키워드)을 수행합니다. 파일/URL/Markdown 업로드 및 검색에 사용.',
      ...
      installCtaHint: 'IntraMind Skill 설치 · 새 탭에서 열림',
    ...
    chrome: {
      title: '지식 관리 어시스턴트',
      subtitle: '자체 호스팅 IntraMind와 함께: 사이드바에서 질문하고, 웹 페이지를 클리핑하며, Markdown 메모를 지식베이스에 저장하세요.',
      ...
      steps: {
        ...
        port: {
          title: '데스크톱: 고정 포트(권장)',
          desc: 'IntraMind 데스크톱에서는 API 정보에서 고정 포트(예: 37841)를 설정하세요.'
        },
        api: {
          title: 'API 자격 증명',
    ...
    api: {
      ...
      signedFlowDetail: 'HMAC secret은 IntraMind와 신뢰할 수 있는 백엔드에만 보관하세요. 요청에 넣거나 브라우저에 배포하지 마세요. 요청 헤더에는 secret이 아니라 해당 secret으로 서명한 JWT 문자열을 넣습니다(발급마다 또는 만료 후 변경). JWT에는 sub(외부 사용자 ID), tenant_id, aud=weknora, exp(최대 24시간)가 필요합니다.',
      ...
      hmacSecretDesc: 'IntraMind에 저장된 것과 동일한 secret. 백엔드에서 JWT 서명에만 사용하며 요청 헤더로 보내지 않습니다.',
  ...
  chat: {
    ...
    referenceDownloadDenied: '해당 문서 다운로드 권한이 없습니다. 지식 기반 관리자에게 문의해 주세요.',
    chunkIdLabel: '청크 ID:',
  ...
  knowledgeEditor: {
    ...
    basic: {
      ...
      visibilityOrg: '조직 공개',
      visibilityGlobal: '전체 공개',
      visibilityTip: '조직 공개: 현재 계정이 속한 조직과 그 하위 조직에 표시됩니다. 전체 공개: 현재 워크스페이스의 모든 조직에 표시됩니다.',
      orgRequired: '현재 계정이 어떤 조직에도 속해 있지 않아 조직 공개를 사용할 수 없습니다.',
  ...
  createChat: {
    title: '안녕하세요, IntraMind입니다 — 당신의 지식을 손끝에',
  ...
  auth: {
    ...
    registerSubtitle: '계정을 만들고 IntraMind를 시작하세요',
  ...
  settings: {
    ...
    sandbox: {
      ...
      templateUntaggedHint: '빌드는 끝났지만 default 태그가 붙은 빌드가 없어 샌드박스 생성 시 이 템플릿을 찾을 수 없습니다. E2B에서 템플릿을 삭제하고 새로고침하면 IntraMind가 다시 빌드합니다.',
  ...
  knowledgeBase: {
    ...
    urlSource: '원본 URL',
    locateInKb: '지식 기반에서 위치 지정',
    docNotFound: '문서를 찾을 수 없거나 삭제된 문서입니다',
    webContent: '웹페이지 내용',
    ...
    batchDownloadDownloading: '압축 파일 생성 중…',
    batchDownloadSuccess: '{count}개 파일을 ZIP으로 다운로드했습니다',
    batchDownloadFailed: '일괄 다운로드에 실패했습니다. 다시 시도해 주세요',
    statusCompleted: '완료',
  ...
  newUserGuide: {
    ...
    steps: {
      ...
      knowledge: {
        title: '지식 베이스 만들기',
        desc: '모든 것의 시작점입니다. 문서, 웹페이지, FAQ를 업로드하면 IntraMind가 자동으로 분석하고 색인합니다. 여기를 클릭해 지식 베이스로 이동하세요.'
      },
      welcome: {
  ...
  admin: {
    ...
    member: {
      ...
      roleEditor: "편집자",
      roleAdmin: "관리자",
      roleSubOrgAdmin: "하위 조직 관리자",
      adjustInTenantMembers: "이 워크스페이스 수준 역할은 공간 구성원 페이지에서 조정하세요",
      ...
      departmentMoved: "회원을 새 부서로 이동했습니다",
    ...
    org: {
      createNode: "조직 노드 만들기",
      editNode: "조직 노드 편집",
      nameLabel: "조직 이름",
      namePlaceholder: "조직 이름을 입력하세요",
      descriptionLabel: "조직 설명",
      descriptionPlaceholder: "조직 설명을 입력하세요 (선택 사항)",
      parentOrgLabel: "상위 조직",
      parentOrgPlaceholder: "상위 조직을 선택하세요 (비워두면 최상위가 됩니다)",
      parentInvalid: "상위 조직으로 자신 또는 하위 조직을 선택할 수 없습니다",
      sortOrder: "정렬 순서",
      nameRequired: "조직 이름을 입력하세요",
      createRoot: "최상위 조직 만들기",
      createFirst: "첫 번째 조직 만들기",
      emptyTree: "아직 조직 데이터가 없습니다",
      createSuccess: "성공적으로 생성되었습니다",
      updateSuccess: "성공적으로 업데이트되었습니다",
      deleteConfirm: "이 조직을 삭제하시겠습니까? 삭제 후 복구할 수 없습니다.",
      deleteSuccess: "삭제 성공",
      deleteFailed: "삭제 실패",
      moveSuccess: "이동 성공",
      moveFailed: "이동 실패",
