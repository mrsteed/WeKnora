export default {
  ...
  agent: {
    ...
    editor: {
      ...
      allowUserKBSelection: "允许用户选择知识库",
      allowUserKBSelectionDescAll: "开启后，用户可以在对话时从全部知识库中选择；关闭后，将自动使用全部知识库",
      allowUserKBSelectionDescSelected: "开启后，用户可以在对话时从关联的知识库中选择；关闭后，将自动使用全部关联的知识库",
