export default {
  ...
  knowledgeBase: {
    ...
    databaseDetail: {
      breadcrumb: "数据库详情",
      subtitle: "围绕连接、Schema 快照与查询审计管理数据库知识库",
      hero: {
        kicker: "业务数据库知识库",
        title: "连接业务库并维护可查询结构",
        description: "当前知识库直接面向业务数据库实时取数，重点维护可查询表结构、字段边界与查询留痕，不再走文档上传流程。",
        connection: "当前接入",
        connectionEmpty: "尚未配置",
        connectionHint: "创建数据库连接后即可拉取业务表结构",
        facts: {
          source: "接入源",
          database: "业务库",
          schema: "Schema",
      ...
      scenarios: {
        title: "页面设计重点",
        item1: "面向实时结构化查询，不再展示文档上传、标签分类和文件列表。",
        item2: "以数据源连接和 Schema 快照为中心，便于定位当前库、表、视图和查询边界。",
        item3: "默认适配只读账号，重点暴露刷新 Schema、查看结构和审计查询三个高频动作。",
      },
      workflow: {
        title: "推荐使用路径",
        item1: "维护数据库连接，确认账号、主机、库名和查询约束。",
        item2: "刷新 Schema 快照，让智能体和人工都能看到最新表结构与字段约束。",
        item3: "通过查询审计回看 SQL 执行结果，定位风险和业务调用情况。",
      },
      snapshot: {
        title: "最新快照",
        database: "数据库",
    ...
    sourceTypeUnknown: "未知来源",
    sourceUnavailable: "暂无源文件信息",
    downloadSource: "下载",
    downloadSourceUnsupported: "当前条目不支持源文件下载",
    downloading: "下载中...",
    deleteFile: "删除文件",
  ...
  chat: {
    ...
    queryDurationLabel: "查询耗时:",
    queryDisplayedRowsLabel: "展示 {displayed} / 共 {total} 行",
    queryOmittedRowsLabel: "还有 {count} 行未展示",
    queryDatabaseTruncatedLabel: "数据库结果已按 max_rows 截断",
    queryOutputTruncatedLabel: "模型输出已按预算裁剪",
    queryCellTruncatedCountLabel: "有 {count} 个单元格已截断",
    schemaOutputModeLabel: "Schema 输出模式:",
    schemaUpdatedAtLabel: "Schema 更新时间:",
    schemaHashLabel: "Schema Hash:",
    schemaTableCountLabel: "表数量:",
    schemaColumnCountLabel: "字段数量:",
    schemaAllowedTablesLabel: "允许查询的表",
    schemaForeignKeysLabel: "真实外键",
    schemaPossibleJoinHintsLabel: "可能的 Join 提示",
    schemaJoinHintsLabel: "Join 提示",
    schemaSampleQueriesLabel: "示例查询",
    schemaPrimaryKeysLabel: "主键:",
    schemaColumnsLabel: "字段",
    schemaIndexesLabel: "索引:",
    schemaRowEstimateLabel: "估算行数:",
    schemaAdditionalTablesOmitted: "还有 {count} 张表未展开",
    schemaAdditionalColumnsOmitted: "还有 {count} 个字段未展开",
    schemaEmptyLabel: "暂无 schema 表信息",
  ...
  auth: {
    ...
    currentPasswordPlaceholder: "请输入当前密码以完成验证",
    ...
    registerFailed: "注册失败",
    subtitle: "欢迎使用 IntraMind-智枢 智能体平台",
    registerSubtitle: "注册后系统将为您创建专属租户",
    accountPlaceholder: "输入邮箱或者手机号",
    emailPlaceholder: "输入邮箱地址",
    passwordPlaceholder: "输入密码（8-32个字符，包含字母和数字）",
    confirmPasswordPlaceholder: "再次输入密码",
    usernamePlaceholder: "输入用户名",
    accountRequired: "请输入用户名、邮箱或者手机号",
  ...
  agent: {
    ...
    pageShare: {
      manageTitle: "共享管理",
      manageDesc: "可将智能体以受限聊天页形式分享给外部访问者，或继续共享到空间供成员使用。",
      sectionTitle: "页面分享",
      sectionDesc: "生成一个无需登录即可访问的聊天链接，访问者只能按当前智能体配置问答，不能修改任何设置。",
      emptyTitle: "尚未开启页面分享",
      emptyDesc: "开启后将生成一个稳定分享链接，可复制给外部访问者直接进入聊天页。",
      enable: "开启分享",
      disable: "关闭分享",
      openLink: "打开链接",
      linkLabel: "分享链接",
      ...
      statusDisabled: "已关闭",
      statusExpired: "已过期",
      enableSuccess: "页面分享已开启",
      disableSuccess: "页面分享已关闭",
  ...
  tenant: {
    ...
    create: {
      button: "新增租户",
      dialogTitle: "新增租户",
      dialogSubtitle: "创建一个新的租户空间，创建完成后你会自动成为该租户的拥有者。",
      nameLabel: "租户名称",
    ...
    management: {
      title: "租户管理",
      description: "集中查看你可访问的租户，支持创建新租户，并在这里切换回已有租户。",
      currentTenantLabel: "当前激活租户",
      totalTenantsLabel: "可切换租户数",
      listTitle: "租户列表",
      listDescription: "这里只展示你当前账号可进入的租户。切换后会刷新页面，并将后续操作切换到目标租户上下文。",
      refresh: "刷新列表",
      loadFailed: "加载租户列表失败，请稍后重试",
      emptyTitle: "暂无可切换租户",
      emptyDescription: "当前账号还没有加入其他租户。你可以先新建租户，或者联系管理员邀请你加入已有租户。",
      currentBadge: "当前",
      homeBadge: "默认",
      currentHint: "你当前正在这个租户下工作。",
      switchHint: "切换后，页面会刷新并进入该租户上下文。",
      currentAction: "当前租户",
      switchAction: "切换到此租户",
      tenantIdLabel: "租户 ID：{id}",
      unnamedTenant: "未命名租户 #{id}",
      roles: {
        owner: "拥有者",
        admin: "管理员",
        contributor: "贡献者",
  ...
  userProfile: {
    title: "个人资料",
    description: "查看当前登录账号的基础信息。",
  },
  tenantMember: {
    title: "空间成员",
    sectionDescription: "查看当前空间成员、待处理邀请和成员变更审计记录。",
    learnRbacGuide: "查看权限说明",
    loading: "加载中...",
    retry: "重试",
    listTitle: "成员列表",
    searchPlaceholder: "搜索用户名或邮箱",
    empty: "当前空间还没有成员",
    emptySearch: "未找到与“{q}”匹配的成员",
    columns: {
      member: "成员",
      role: "角色",
      joinedAt: "加入时间",
    ...
    permissions: {
      title: "角色权限",
      iconHint: "查看角色权限说明",
      desc: "不同角色在当前空间中的可操作范围。",
      manageMembers: "管理成员与邀请",
      manageTenantConfig: "修改空间配置",
      manageInfra: "管理模型、存储等空间能力",
      createOwnKB: "创建自己的知识库/资源",
      readAll: "查看并使用空间内容",
    },
    add: {
      button: "邀请成员",
      dialogTitle: "发送成员邀请",
      emailLabel: "邮箱",
      emailPlaceholder: "请输入已注册用户的邮箱",
      roleLabel: "角色",
    },
    remove: {
      button: "移除",
      confirm: "确认移除",
      confirmBody: "确认将“{name}”移出当前空间吗？",
      success: "成员已移除",
    },
    roleChange: {
      success: "成员角色已更新",
    ...
    leave: {
      confirmTitle: "退出空间",
      confirmBody: "退出后将无法继续访问当前空间内容，确定要继续吗？",
      confirm: "确认退出",
      success: "已退出当前空间",
    },
    errors: {
      ...
      roleRequired: "请选择角色",
      generic: "操作失败，请稍后重试",
      userNotFound: "该邮箱未找到已注册用户",
      invalidRole: "角色参数无效",
      lastOwner: "无法移除或降级最后一位拥有者",
      notFound: "成员不存在或已被删除",
    },
    audit: {
      tabLabel: "审计日志",
      description: "查看成员变更、权限调整及访问拒绝记录。",
      refresh: "刷新",
      empty: "暂无审计记录",
      systemActor: "系统",
      end: "已经到底了",
      forbidden: "当前角色无权查看审计日志",
      requiredRole: "要求角色：{role}",
      columns: {
        time: "时间",
        actor: "操作人",
        action: "动作",
      ...
      action: {
        'rbac.member_added': '添加成员',
        'rbac.member_removed': '移除成员',
        'rbac.member_left': '成员退出空间',
        'rbac.member_role_changed': '变更成员角色',
        'rbac.access_denied': '权限拒绝',
      },
    },
  },
  tenantInvitation: {
    inboxTooltip: "查看待处理邀请",
    pendingSectionTitle: "待处理邀请",
    pendingSectionDesc: "已发送但尚未被接受的邀请，默认有效期 {days} 天。",
    pendingEmpty: "当前没有待处理邀请",
    confirmInviteTitle: "确认发送邀请",
    confirmInviteBody: "确认以“{role}”角色邀请 {email} 加入当前空间吗？",
    inviteSubmit: "下一步",
    confirmSend: "发送邀请",
    inviteSuccess: "邀请已发送",
    columns: {
    ...
    revoke: {
      button: "撤销",
      confirm: "确认撤销",
      confirmBody: "确认撤销对 {email} 的邀请吗？",
      success: "邀请已撤销",
    },
    errors: {
      generic: "邀请操作失败，请稍后重试",
      notFound: "邀请不存在或已被处理",
      notPending: "该邀请已不是待处理状态",
      alreadyMember: "该用户已经是当前空间成员",
      pendingExists: "该用户已有待处理邀请",
      forbidden: "无权处理这条邀请",
    },
    myInbox: {
      title: "我的邀请",
      description: "查看并处理其他空间发给你的加入邀请。",
      empty: "当前没有待处理邀请",
      tenantLabel: "空间",
      from: "邀请人",
      expiresIn: "到期时间：{date}",
  ...
  system: {
    ...
    retry: "重试",
    versionLabel: "应用版本",
    versionDescription: "当前应用服务（IntarMind）的版本号",
    ...
    startedAtDescription: "当前服务实例最近一次完成启动的时间",
    uptimeLabel: "运行时长",
    uptimeDescription: "当前服务实例持续运行的时长",
    uptimeDays: "{n}天",
    uptimeHours: "{n}小时",
    uptimeMinutes: "{n}分钟",
    uptimeSeconds: "{n}秒",
    ...
    globalSettings: {
      title: "系统设置",
      description: "管理平台级运行参数、默认值和系统管理员名单。修改后会立即写入后端配置表，部分项可能需要重启后生效。",
      loading: "正在加载系统设置...",
      empty: "暂无可编辑的系统设置项",
      badgeRequiresRestart: "需重启",
      badgeSecret: "敏感",
      badgeOverride: "已覆盖",
      badgeOverrideTooltip: "该值已覆盖环境变量或内置默认值",
      modifiedAt: "最后修改：{value}",
      tagInputPlaceholder: "输入后回车添加",
      priorityHint: {
        title: "配置优先级",
        tier1: "系统设置表中的覆盖值优先级最高。",
        tier2: "若没有覆盖值，则回退到服务启动时读取的环境变量。",
        tier3: "若前两层都为空，则使用代码中的默认值。",
      },
      confirm: {
        confirmBtn: "确认",
        cancelBtn: "取消",
        emptyValue: "空值",
        bodyAuthRegistrationMode: "确认将注册模式切换为“{value}”？该修改会立即影响注册入口。",
      },
      messages: {
        loadFailed: "加载系统设置失败",
        saveSuccess: "保存成功",
      ...
      reset: {
        label: "重置",
        tooltip: "移除此项覆盖值，回退到环境变量或默认值",
        confirmBody: "确认重置“{label}”吗？",
        confirmBtn: "确认重置",
        success: "已恢复默认来源",
        failed: "重置失败，请稍后重试",
      },
      bulkApply: {
        label: "应用到全部租户",
        tooltip: "将当前值批量同步到所有现有租户",
        confirmBtn: "确认应用",
        confirmBody: "确认将当前值“{value}”应用到全部租户吗？",
        success: "已应用到 {count} 个租户",
        failed: "批量应用失败，请稍后重试",
      },
      admins: {
        label: "系统管理员",
        description: "维护拥有平台级管理权限的管理员邮箱列表。变更会直接触发提升或撤销系统管理员权限。",
        placeholder: "输入邮箱后回车添加系统管理员",
        loadFailed: "加载系统管理员列表失败",
        saveSuccess: "系统管理员列表更新成功",
        saveFailed: "更新系统管理员列表失败",
        confirm: {
          promote: {
            body: "确认将 {email} 提升为系统管理员吗？",
            confirmBtn: "确认提升",
          },
          revoke: {
            body: "确认撤销 {email} 的系统管理员权限吗？",
            confirmBtn: "确认撤销",
          },
        },
      },
      keyLabels: {
        'auth.registration_mode': '注册模式',
        'tenant.default_storage_quota_gb': '租户默认存储配额',
        'ssrf.whitelist': 'SSRF 白名单',
        'tenant.max_owned_per_user': '单用户可拥有租户上限',
      ...
      listConfirm: {
        'ssrf.whitelist': {
          add: {
            body: '确认将“{entry}”加入 SSRF 白名单吗？',
            confirmBtn: '确认加入',
          },
          remove: {
            body: '确认将“{entry}”从 SSRF 白名单中移除吗？',
            confirmBtn: '确认移除',
          },
        },
      },
      audit: {
        tabLabel: '审计日志',
        description: '查看系统设置与系统管理员权限变更的审计记录。',
        refresh: '刷新',
        retry: '重试',
        loading: '正在加载更多记录...',
        end: '已显示全部审计记录',
        ...
        target: {
          bulkQuota: '租户默认配额',
          bulkQuotaDiff: '从 {oldValue} 调整为 {newValue}',
          promoteIdempotent: '目标用户已经是系统管理员',
          revokeNoop: '目标用户当前不是系统管理员',
          requiredRole: '要求角色：{role}',
          valueNull: '空值',
        },
        errors: {
        ...
        action: {
          'system.setting_changed': '修改系统设置',
          'system.setting_reset': '重置系统设置',
          'system.setting_bulk_applied': '批量应用系统设置',
          'system.admin_promoted': '提升系统管理员',
          'system.admin_revoked': '撤销系统管理员',
        },
      },
    },
    unknown: "未知",
  ...
  newUserGuide: {
    ...
    steps: {
      welcome: {
        title: '欢迎使用 WeKnora',
        desc: '接下来用几步带你快速熟悉知识库、智能体、对话和设置入口。',
      },
      knowledge: {
        title: '这里进入知识库',
        desc: '知识库用于上传文档、管理结构化数据和组织可检索内容，是大多数问答场景的起点。',
      },
      agents: {
        title: '这里管理智能体',
        desc: '你可以创建具备不同提示词、工具权限和知识范围的智能体，用于特定业务场景。',
      },
      chat: {
        title: '这里创建新对话',
        desc: '从这里快速发起新的聊天，会根据你选择的知识库或智能体进入对应工作流。',
      },
      settings: {
        title: '这里打开设置',
        desc: '常用设置、模型管理、解析引擎、存储引擎和系统信息都集中在这里。',
      },
      models: {
        title: '先配置模型能力',
        desc: '建议先在设置中确认对话模型、嵌入模型和重排模型，后续知识库和智能体都会用到。',
      },
      done: {
        title: '现在可以开始了',
        desc: '你已经了解了主要入口。接下来可以创建知识库、配置模型，或直接开始一次新对话。',
      },
    },
  },
  error: {
  ...
  model: {
    ...
    editor: {
      ...
      apiKeyConfiguredPlaceholder: "已配置 API Key；如需修改请输入新值",
      apiKeyConfiguredHint: "当前 API Key 已保存，留空保持不变。",
  ...
  knowledgeEditor: {
    ...
    basic: {
      ...
      typeFAQ: "问答",
      typeDatabase: "数据库",
      typeDescription: "FAQ 类型适合结构化问答数据；文档型支持文件解析与分块；数据库类型用于绑定外部数据库并执行实时只读查询；Wiki 类型由 LLM 自动构建互链知识页面。",
      nameLabel: "知识库名称",
      ...
      organizationPlaceholder: "请选择所属组织",
    },
    database: {
      title: "数据库连接",
      description: "配置外部数据库连接信息，创建时会自动校验连通性并初始化首份 Schema。",
      engineLabel: "数据库类型",
      engineTip: "当前支持 MySQL 和 PostgreSQL，创建成功后会自动绑定到该数据库型知识库。",
      dataSourceNameLabel: "数据源名称",
      dataSourceNamePlaceholder: "留空则默认使用知识库名称",
      dataSourceNameTip: "用于后续在“数据源”页识别该连接，可选填写。",
      hostLabel: "主机地址",
      ...
      passwordLabel: "密码",
      passwordPlaceholder: "请输入只读账号密码",
      sslModeLabel: "SSL 模式",
      sslModePlaceholder: "MySQL: false / preferred / required；PostgreSQL: disable / require / verify-full",
      sslModeTip: "按目标数据库驱动的取值填写；留空时会使用当前数据库类型的默认值。",
      queryConstraintTitle: "查询约束",
      queryConstraintDescription: "限制 Agent 可访问的表和字段，并设置默认返回行数与超时时间。",
      tableAllowlistLabel: "表白名单",
      tableAllowlistPlaceholder: "orders\ncustomers\norder_items",
      tableAllowlistTip: "为空表示不额外限制；填写后仅允许查询这些表，支持逗号或换行分隔。",
      columnDenylistLabel: "字段黑名单",
      columnDenylistPlaceholder: "password_hash\nid_card\nmobile",
      columnDenylistTip: "这些字段会被视为敏感列，Schema 展示和实时查询都会受限。",
      maxRowsLabel: "最大返回行数",
  ...
  agentEditor: {
    ...
    tools: {
      ...
      statusKb: "作用域内：{rag} 个 RAG 知识库 · {wiki} 个 Wiki 知识库 · {database} 个数据库知识库",
      kbMetricRag: "RAG 知识库",
      kbMetricWiki: "Wiki 知识库",
      kbMetricDatabase: "数据库知识库",
  ...
  datasource: {
    ...
    lastStatus: "同步结果",
    databaseName: "业务库",
    databaseSchemaLabel: "结构范围",
    databaseSchemaDefault: "默认 Schema",
    databaseLastSync: "上次刷新结构",
    databaseLastStatus: "结构状态",
    databaseLastStatusReady: "结构已更新",
    databaseLastStatusPending: "未采集结构",
    schedule: "同步频率",
    syncModeLabel: "同步模式",
    syncMode: {
      incremental: "增量同步",
  ...
  admin: {
    ...
    org: {
      ...
      descriptionLabel: "描述",
      descriptionPlaceholder: "请输入组织描述（可选）",
      sortOrder: "排序",
      ...
      deleteSuccess: "删除成功",
      deleteFailed: "删除失败",
      deleteConfirm: "确定要删除该组织节点吗？子节点也将被删除。",
      moveSuccess: "移动成功",
      moveFailed: "移动失败",
    },
    member: {
      selectOrg: "选择组织",
      selectOrgHint: "请先在左侧选择一个组织",
      addMember: "添加成员",
      ...
      revokeAdmin: "取消管理员",
      setSuperAdmin: "设为超管",
      revokeSuperAdmin: "取消超管",
      superAdmin: "超级管理员",
      remove: "移除",
      removeConfirm: "确定要将该用户移出组织吗？",
      ...
      phone: "手机号",
      phonePlaceholder: "输入手机号（可选）",
      emailOptionalPlaceholder: "输入邮箱（可选）",
      passwordPlaceholder: "输入密码（8-32个字符）",
      usernamePlaceholder: "输入用户名",
      emailOrPhoneRequired: "邮箱和手机号至少填写一个",
      ...
      resetPassword: "重置密码",
      resetPasswordFor: "重置「{org}」中用户密码",
      resetPasswordSuccess: "密码重置成功",
      resetPasswordFailed: "密码重置失败",
      cannotResetOwnPassword: "不能在人员管理中重置自己的密码",
      updateUserSuccess: "用户更新成功",
      updateUserFailed: "用户更新失败",
    },
  },
  org: {
    switchPlaceholder: "选择组织",
    selectTargetOrg: "选择目标组织",
  },
