  ...
  knowledgeEditor: {
    ...
    advanced: {
      ...
      graph: {
        ...
        nodesLabel: "节点配置",
        nodesDescription: "定义需要提取的实体节点类型及其属性",
        addNode: "添加节点",
        nodeNameLabel: "节点名称",
        nodeNamePlaceholder: "如：Person、Organization",
        nodeChunksLabel: "关联文档块",
        nodeChunksPlaceholder: "输入 chunk ID 后按回车",
        nodeAttributesLabel: "节点属性",
        nodeAttributesPlaceholder: "输入属性名后按回车",
        relationsLabel: "关系配置",
        relationsDescription: "定义节点之间的关系类型",
        addRelation: "添加关系",
        relationNode1Label: "起始节点",
        relationNode1Placeholder: "如：Person",
        relationNode2Label: "目标节点",
        relationNode2Placeholder: "如：Organization",
        relationTypeLabel: "关系类型",
        relationTypePlaceholder: "如：WORKS_FOR、BELONGS_TO",
        deleteNode: "删除节点",
        deleteRelation: "删除关系",
        disabledWarning:
          "图数据库未启用，无法使用知识图谱功能。请先根据《开启知识图谱功能指南》完成配置。",
        howToEnable: "查看启用说明",
      },
    },
  },
