export default {
  ...
  agent: {
    ...
    editor: {
      ...
      basicInfoDesc: 'Настройка имени, описания, видимости и режима работы агента',
...
/example\.(net|org)/`,
  ...
  system: {
    ...
    globalSettings: {
      ...
      keyLabels: {
        "auth.registration_mode": 'Режим самостоятельной регистрации',
        "ssrf.whitelist": 'Белый список SSRF-защиты',
        "tenant.max_owned_per_user": 'Максимум тенантов на пользователя',
        "tenant.default_storage_quota_gb": 'Квота хранилища для новых тенантов по умолчанию (ГБ)',
        "asynq.concurrency": 'Параллелизм воркеров асинхронных задач',
      },
      keyDescriptions: {
  ...
  knowledgeEditor: {
    ...
    basic: {
      ...
      visibilityOrg: 'Видно организации',
      visibilityGlobal: 'Видно всему пространству',
      visibilityTip: 'Видно организации: база знаний видна организации текущего аккаунта и её дочерним организациям. Глобально: база знаний видна всем организациям текущего рабочего пространства.',
      organizationLabel: 'Организация',
      orgRequired: 'Текущий аккаунт не состоит ни в одной организации, поэтому режим видимости организации недоступен.',
  ...
  chat: {
    ...
    webFetchStatusTitle: 'Статус загрузки',
    webFetchRequestedLabel: 'Запрошено страниц',
    webFetchFetchedLabel: 'Успешно загружено страниц',
    webFetchFailedLabel: 'Страниц с ошибкой загрузки',
    webFetchAllFailedNotice: 'Не удалось получить ни одной полной страницы. Последующий ответ должен опираться только на предыдущие сниппеты веб-поиска.',
    webFetchPartialNotice: 'Полный текст получен для {fetched} из {requested} страниц. Остальные страницы следует считать только сниппетами из веб-поиска.',
  ...
  agentEditor: {
    ...
    tools: {
      ...
      requiresDatabaseKb: '(требуется база знаний типа database)',
    ...
    agentType: {
      ...
      kbMismatch: {
        ...
        databaseAnalysis: 'Требуется база знаний типа database',
  ...
  userProfile: {
    ...
    changePasswordTitle: 'Изменить пароль для входа',
    changePasswordConfirm: 'Изменить',
    changePasswordSuccess: 'Пароль обновлён',
    changePasswordFailed: 'Не удалось изменить пароль, проверьте введённые данные',
    changePasswordDesc: 'Сначала введите текущий пароль, затем новый. Новый пароль должен быть длиной 8–32 символа, содержать буквы и цифры и не совпадать с именем пользователя.',
    fields: {
    ...
    placeholders: {
      ...
      newPassword: 'Новый пароль (8–32 символа, буквы и цифры)',
    ...
    errors: {
      ...
      weak: 'Новый пароль должен быть длиной 8–32 символов, содержать буквы и цифры и не совпадать с именем пользователя',
      tooShort: 'Новый пароль слишком короткий, минимум 8 символов',
      tooLong: 'Новый пароль слишком длинный, максимум 32 символа',
      oldWrong: 'Текущий пароль указан неверно',
      changePasswordUnknown: 'Не удалось изменить пароль, попробуйте позже',
    },
  },
  tenantMember: {
    title: 'Участники',
