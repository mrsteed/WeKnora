...
/example\.(net|org)/`,
  ...
  auth: {
    ...
    rememberCredentials: 'Запомнить имя пользователя и пароль',
    ...
    accountPlaceholder: 'Введите email или номер телефона',
    ...
    accountRequired: 'Введите имя пользователя, email или номер телефона',
  ...
  tenant: {
    ...
    leaveDangerZone: {
      title: 'Покинуть текущего арендатора',
      desc: 'После выхода вы потеряете членство и доступ к этому арендатору. Если нужно вернуться, попросите владельца арендатора или администратора пригласить вас снова.',
      button: 'Покинуть арендатора'
    },
    messages: {
  ...
  knowledgeEditor: {
    ...
    basic: {
      ...
      typeDatabase: 'База данных',
      typeDescription: 'FAQ подходит для структурированных Q&A; документальный тип поддерживает загрузку файлов и разбиение; тип базы данных подключает внешнюю БД для чтения в реальном времени; Wiki автоматически создает связанные страницы знаний через LLM.',
  ...
  chat: {
    ...
    queryDurationLabel: 'Время запроса:',
    queryDisplayedRowsLabel: 'Показано {displayed} из {total} строк',
    queryOmittedRowsLabel: 'Скрыто ещё {count} строк',
    queryDatabaseTruncatedLabel: 'Результат БД обрезан по max_rows',
    queryOutputTruncatedLabel: 'Применён бюджет вывода модели',
    queryCellTruncatedCountLabel: 'Обрезано ячеек: {count}',
    schemaOutputModeLabel: 'Режим вывода schema:',
    schemaUpdatedAtLabel: 'Schema обновлена:',
    schemaHashLabel: 'Хэш schema:',
    schemaTableCountLabel: 'Количество таблиц:',
    schemaColumnCountLabel: 'Количество столбцов:',
    schemaAllowedTablesLabel: 'Разрешённые таблицы',
    schemaForeignKeysLabel: 'Внешние ключи',
    schemaPossibleJoinHintsLabel: 'Возможные подсказки join',
    schemaJoinHintsLabel: 'Подсказки join',
    schemaSampleQueriesLabel: 'Примеры запросов',
    schemaPrimaryKeysLabel: 'Первичные ключи:',
    schemaColumnsLabel: 'Столбцы',
    schemaIndexesLabel: 'Индексы:',
    schemaRowEstimateLabel: 'Оценка строк:',
    schemaAdditionalTablesOmitted: 'Ещё {count} таблиц скрыто',
    schemaAdditionalColumnsOmitted: 'Ещё {count} столбцов скрыто',
    schemaEmptyLabel: 'Нет данных schema для отображения',
    ...
    streamUnavailable: 'Генерация ответа была прервана, и историю потока восстановить нельзя. Сгенерируйте ответ заново.',
    recoveredPartialHint: 'Произошла восстановимая ошибка инструмента, но сгенерированное содержимое сохранено. Можно продолжить или сгенерировать заново.',
  ...
  agentEditor: {
    ...
    tools: {
      ...
      statusKb: 'В области: {rag} RAG баз · {wiki} Wiki баз · {database} баз данных',
      kbMetricRag: 'RAG баз',
      kbMetricWiki: 'Wiki баз',
      kbMetricDatabase: 'баз данных',
