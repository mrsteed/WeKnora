export default {
  ...
  integrations: {
    ...
    claw: {
      ...
      subtitle: 'Импорт документов и гибридный поиск (вектор + ключевые слова) через REST API IntraMind — загрузки, URL, Markdown и поиск.',
      ...
      installCtaHint: 'Установка IntraMind Skill · откроется в новой вкладке',
    ...
    chrome: {
      ...
      subtitle: 'Для self-hosted IntraMind: вопросы в боковой панели, клиппинг страниц и Markdown-заметки в базы знаний прямо при просмотре.',
      ...
      steps: {
        ...
        port: {
          ...
          desc: 'В IntraMind Desktop задайте фиксированный порт API (например 37841) в API-информации.'
        },
        api: {
    ...
    api: {
      ...
      hmacSecretDesc: 'Тот же secret, что в IntraMind; только для подписи JWT на backend — не отправляйте его в заголовке запроса.',
  ...
  chat: {
    ...
    referenceDownloadDenied: 'У вашей учётной записи нет прав на скачивание этого документа. Обратитесь к администратору базы знаний.',
  ...
  knowledgeEditor: {
    ...
    basic: {
      ...
      visibilityOrg: 'Видно организации',
      visibilityGlobal: 'Видно всему пространству',
      visibilityTip: 'Видно организации: ресурс виден организации текущего аккаунта и её дочерним организациям. Глобально: ресурс виден всем организациям текущего рабочего пространства.',
      orgRequired: 'Текущий аккаунт не состоит ни в одной организации, поэтому режим видимости организации недоступен.',
  ...
  createChat: {
    title: 'Привет, я IntraMind — ваши знания всегда под рукой',
  ...
  auth: {
    ...
    registerSubtitle: 'Создайте аккаунт и начните работу с IntraMind',
  ...
  settings: {
    ...
    sandbox: {
      ...
      templateUntaggedHint: 'Сборки завершены, но ни одна не имеет тега default, поэтому при создании песочницы шаблон не находится. Удалите его в E2B и обновите список — IntraMind пересоберёт шаблон.',
  ...
  knowledgeBase: {
    ...
    locateInKb: 'Показать в базе знаний',
    docNotFound: 'Документ не найден или удалён',
    ...
    batchDownloadDownloading: 'Формируется архив…',
    batchDownloadSuccess: 'Загружено файлов: {count}',
    batchDownloadFailed: 'Пакетная загрузка не удалась',
  ...
  newUserGuide: {
    ...
    steps: {
      ...
      knowledge: {
        ...
        desc: 'С этого всё начинается: загружайте документы, веб-страницы или FAQ, и IntraMind автоматически разберёт и проиндексирует их. Нажмите здесь, чтобы открыть базы знаний.'
      },
      welcome: {
        title: 'Добро пожаловать в IntraMind',
  ...
  admin: {
    ...
    organ: {
      orgPanel: 'Дерево организации',
    },
    member: {
      selectOrg: 'Выбрать организацию',
      selectOrgHint: 'Выберите организацию слева, чтобы увидеть её участников',
      ...
      createUserTo: 'Создать пользователя в «{org}»',
      createUserSuccess: 'Пользователь создан',
      createUserFailed: 'Не удалось создать пользователя',
      addMember: 'Добавить участника',
      addMemberTo: 'Добавить участника в «{org}»',
      searchUser: 'Поиск пользователя',
      searchUserPlaceholder: 'Поиск по имени, почте или телефону',
      noUsersFound: 'Подходящие пользователи не найдены',
      roleViewer: 'Чтение',
      roleEditor: 'Редактор',
      roleAdmin: 'Администратор',
      roleSubOrgAdmin: 'Администратор подразделения',
      adjustInTenantMembers: 'Изменяйте эту роль уровня рабочего пространства на странице участников рабочего пространства',
      usernamePlaceholder: 'Введите имя пользователя',
      emailOptionalPlaceholder: 'Необязательно, введите эл. почту',
      phonePlaceholder: 'Необязательно, введите телефон',
      passwordPlaceholder: '8–32 символа, буквы и цифры',
      editUserIn: 'Изменить пользователя в «{org}»',
      updateUserSuccess: 'Данные пользователя обновлены',
      department: 'Подразделение',
      departmentPlaceholder: 'Выберите подразделение',
      departmentMoved: 'Участник переведён в новое подразделение',
      updateUserFailed: 'Не удалось обновить пользователя',
      emailOrPhoneRequired: 'Укажите эл. почту или телефон',
      assignSuccess: 'Участник добавлен',
      removeSuccess: 'Участник удалён',
      removeFailed: 'Не удалось удалить участника',
      remove: 'Удалить',
      removeConfirm: 'Удалить этого участника?',
      cannotModifySelf: 'Нельзя изменить свою роль участника',
      setAdmin: 'Назначить администратором',
      revokeAdmin: 'Снять администратора',
      resetPassword: 'Сбросить пароль',
      resetPasswordFor: 'Сброс пароля участника в «{org}»',
      resetPasswordSuccess: 'Пароль сброшен',
      resetPasswordFailed: 'Не удалось сбросить пароль',
      updateSuccess: 'Успешно обновлено',
      inheritedAdmin: 'Унаследованный администратор',
      inheritedAdminHint: 'Унаследовано от родительской организации',
      inheritedFrom: 'Из',
    },
    org: {
      createNode: 'Создать узел организации',
      editNode: 'Редактировать узел организации',
      nameLabel: 'Название организации',
      namePlaceholder: 'Введите название организации',
      descriptionLabel: 'Описание организации',
      descriptionPlaceholder: 'Введите описание организации (необязательно)',
      parentOrgLabel: 'Родительская организация',
      parentOrgPlaceholder: 'Выберите родительскую (оставьте пустым для корневой)',
      parentInvalid: 'Нельзя выбрать узел как собственный потомок',
      sortOrder: 'Порядок сортировки',
      nameRequired: 'Введите название организации',
      createRoot: 'Создать корневую организацию',
      createFirst: 'Создать первую организацию',
      emptyTree: 'Пока нет данных организации',
      createSuccess: 'Успешно создано',
      updateSuccess: 'Успешно обновлено',
      deleteConfirm: 'Удалить эту организацию? Это действие нельзя отменить.',
      deleteSuccess: 'Успешно удалено',
      deleteFailed: 'Не удалось удалить',
