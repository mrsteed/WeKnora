...
func (r *fakeKBRepo) ListAccessibleKBs(_ context.Context, _ string, _ uint64, _ []string) ([]*types.KnowledgeBase, error) {
	return nil, nil
}
func (r *fakeKBRepo) ListKBsByOrganization(_ context.Context, _ string) ([]*types.KnowledgeBase, error) {
	return nil, nil
}
