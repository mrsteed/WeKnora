...
func (r *realKBRepo) ListAccessibleKBs(_ context.Context, _ string, _ uint64, _ []string) ([]*types.KnowledgeBase, error) {
	return nil, nil
}
func (r *realKBRepo) ListKBsByOrganization(_ context.Context, _ string) ([]*types.KnowledgeBase, error) {
	return nil, nil
}
