...
func RegisterSyncHandlers(params SyncTaskParams) {
	...
	params.Executor.RegisterHandler(types.TypeKnowledgeFileDispatch, params.KnowledgeService.ProcessKnowledgeFileDispatch)
	...
	params.Executor.RegisterHandler(types.TypeLongDocumentExecution, params.LongDocumentTask.Handle)
