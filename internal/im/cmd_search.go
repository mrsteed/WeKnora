...
func newSearchCommand(
	...
	return &SearchCommand{sessionService: sessionService, kbService: kbService, kbScope: kbScope}
}
...
func (c *SearchCommand) Execute(ctx context.Context, cmdCtx *CommandContext, args []string) (*CommandResult, error) {
	...
	if cmdCtx.CustomAgent != nil {
		if c.kbScope != nil {
			resolvedKBIDs, err := c.kbScope.ResolveKnowledgeBaseIDs(ctx, cmdCtx.CustomAgent, cmdCtx.TenantID)
			if err != nil {
