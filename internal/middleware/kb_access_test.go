...
func (s *stubKBShareForGuard) UpdateSharePermission(context.Context, string, types.OrgMemberRole, string) error {
	panic("not implemented")
}
func (s *stubKBShareForGuard) RemoveShare(context.Context, string, string) error {
	panic("not implemented")
}
...
func (s *stubKBShareForGuard) ListSharedKnowledgeBases(context.Context, string, uint64) ([]*types.SharedKnowledgeBaseInfo, error) {
	panic("not implemented")
}
func (s *stubKBShareForGuard) ListSharedKnowledgeBasesInOrganization(context.Context, string, string, uint64) ([]*types.OrganizationSharedKnowledgeBaseItem, error) {
	panic("not implemented")
}
func (s *stubKBShareForGuard) ListSharedKnowledgeBaseIDsByOrganizations(context.Context, []string, string) (map[string][]string, error) {
	panic("not implemented")
}
...
func (s *stubKBShareForGuard) CheckUserKBPermission(context.Context, string, string) (types.OrgMemberRole, bool, error) {
	panic("not implemented")
}
func (s *stubKBShareForGuard) HasKBPermission(context.Context, string, string, types.OrgMemberRole) (bool, error) {
	panic("not implemented")
}
...
func (s *stubAgentShareForGuard) RemoveShare(context.Context, string, string) error {
	panic("not implemented")
}
...
func (s *stubAgentShareForGuard) ListSharedAgents(context.Context, string, uint64) ([]*types.SharedAgentInfo, error) {
	panic("not implemented")
}
func (s *stubAgentShareForGuard) ListSharedAgentsInOrganization(context.Context, string, string, uint64) ([]*types.OrganizationSharedAgentItem, error) {
	panic("not implemented")
}
func (s *stubAgentShareForGuard) ListSharedAgentsInOrganizations(context.Context, []string, string, uint64) (map[string][]*types.OrganizationSharedAgentItem, error) {
	panic("not implemented")
}
...
func (s *stubAgentShareForGuard) GetSharedAgentForUser(context.Context, string, uint64, string) (*types.CustomAgent, error) {
	panic("not implemented")
}
func (s *stubAgentShareForGuard) UserCanAccessKBViaSomeSharedAgent(context.Context, string, uint64, *types.KnowledgeBase) (bool, error) {
	panic("not implemented")
}
func (s *stubAgentShareForGuard) GetShareByAgentIDForUser(context.Context, string, string, uint64) (*types.AgentShare, error) {
	panic("not implemented")
}
