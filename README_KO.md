...
<table>
  ...
  <tr>
    <td colspan="2" align="center"><b>🤖 Agent 모드 · 도구 호출 과정</b><br/><img src="./docs/images/agent-qa.png" alt="Agent 모드 도구 호출 과정" width="100%"></td>
  </tr>
  <tr>
    <td width="50%" align="center"><b>📚 지식베이스 관리</b><br/><img src="./docs/images/knowledgebases.png" alt="지식베이스 관리" width="100%"></td>
